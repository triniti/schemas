...
final class RemoveArticleSlottingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:command:remove-article-slotting:v1';
    const MIXINS = [
