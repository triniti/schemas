...
{
    const SCHEMA_ID = 'pbj:triniti:news:command:sync-facebook-instant-article:1-0-1';
    const SCHEMA_CURIE = 'triniti:news:command:sync-facebook-instant-article';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:command:sync-facebook-instant-article:v1';
    const MIXINS = [
