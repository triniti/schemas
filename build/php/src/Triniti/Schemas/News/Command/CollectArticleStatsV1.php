...
final class CollectArticleStatsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:command:collect-article-stats:v1';
    const MIXINS = [
