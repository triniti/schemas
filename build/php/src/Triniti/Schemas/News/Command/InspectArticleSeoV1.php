...
{
    const SCHEMA_ID = 'pbj:triniti:news:command:inspect-article-seo:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:command:inspect-article-seo';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:command:inspect-article-seo:v1';
    const MIXINS = [
