...
namespace Triniti\Schemas\News\Request;
...
final class SearchArticlesResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:request:search-articles-response:v1';
    const MIXINS = [
