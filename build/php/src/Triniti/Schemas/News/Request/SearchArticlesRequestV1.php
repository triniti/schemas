...
{
    const SCHEMA_ID = 'pbj:triniti:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:request:search-articles-request:v1';
    const MIXINS = [
