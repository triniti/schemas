...
final class AppleNewsArticleSyncedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:event:apple-news-article-synced:v1';
    const MIXINS = [
