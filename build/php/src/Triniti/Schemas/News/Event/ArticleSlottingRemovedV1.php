...
final class ArticleSlottingRemovedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:event:article-slotting-removed:v1';
    const MIXINS = [
