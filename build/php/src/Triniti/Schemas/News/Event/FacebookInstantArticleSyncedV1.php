...
final class FacebookInstantArticleSyncedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:event:facebook-instant-article-synced:1-0-1';
    const SCHEMA_CURIE = 'triniti:news:event:facebook-instant-article-synced';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:event:facebook-instant-article-synced:v1';
    const MIXINS = [
