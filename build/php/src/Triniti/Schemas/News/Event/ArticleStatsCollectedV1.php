...
final class ArticleStatsCollectedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'triniti:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'triniti:news:event:article-stats-collected:v1';
    const MIXINS = [
