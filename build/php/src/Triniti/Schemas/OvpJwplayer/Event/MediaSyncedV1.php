...
{
    const SCHEMA_ID = 'pbj:triniti:ovp.jwplayer:event:media-synced:1-0-2';
    const SCHEMA_CURIE = 'triniti:ovp.jwplayer:event:media-synced';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp.jwplayer:event:media-synced:v1';
    const MIXINS = [
