...
// @link http://schemas.triniti.io/json-schema/triniti/apollo/request/search-polls-response/1-0-0.json#
namespace Triniti\Schemas\Apollo\Request;
...
final class SearchPollsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:apollo:request:search-polls-response:v1';
    const MIXINS = [
