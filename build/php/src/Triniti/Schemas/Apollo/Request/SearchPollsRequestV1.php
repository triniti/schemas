...
// @link http://schemas.triniti.io/json-schema/triniti/apollo/request/search-polls-request/1-0-0.json#
...
final class SearchPollsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:apollo:request:search-polls-request:v1';
    const MIXINS = [
