...
{
    const SCHEMA_ID = 'pbj:triniti:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'triniti:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'triniti:apollo:event:vote-casted:v1';
    const MIXINS = [
