...
namespace Triniti\Schemas\Apollo\Event;
...
final class ReactionsAddedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:apollo:event:reactions-added:1-0-0';
    const SCHEMA_CURIE = 'triniti:apollo:event:reactions-added';
    const SCHEMA_CURIE_MAJOR = 'triniti:apollo:event:reactions-added:v1';
    const MIXINS = [
