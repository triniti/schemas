...
final class AddReactionsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:apollo:command:add-reactions:1-0-0';
    const SCHEMA_CURIE = 'triniti:apollo:command:add-reactions';
    const SCHEMA_CURIE_MAJOR = 'triniti:apollo:command:add-reactions:v1';
    const MIXINS = [
