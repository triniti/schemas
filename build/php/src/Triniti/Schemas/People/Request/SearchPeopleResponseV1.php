...
final class SearchPeopleResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:people:request:search-people-response:v1';
    const MIXINS = [
