...
final class SearchAssetsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:request:search-assets-response:v1';
    const MIXINS = [
