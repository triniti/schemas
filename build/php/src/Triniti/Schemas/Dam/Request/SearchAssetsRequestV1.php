...
final class SearchAssetsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:request:search-assets-request:v1';
    const MIXINS = [
