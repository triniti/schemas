...
{
    const SCHEMA_ID = 'pbj:triniti:dam:request:get-upload-urls-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:request:get-upload-urls-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:request:get-upload-urls-response:v1';
    const MIXINS = [
