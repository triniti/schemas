...
final class GalleryAssetReorderedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [
