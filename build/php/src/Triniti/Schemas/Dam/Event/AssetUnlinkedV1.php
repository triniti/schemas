...
final class AssetUnlinkedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:event:asset-unlinked:v1';
    const MIXINS = [
