...
final class UnlinkAssetsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:command:unlink-assets:v1';
    const MIXINS = [
