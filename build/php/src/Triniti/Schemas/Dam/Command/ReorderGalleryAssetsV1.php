...
namespace Triniti\Schemas\Dam\Command;
...
final class ReorderGalleryAssetsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:command:reorder-gallery-assets:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:command:reorder-gallery-assets';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:command:reorder-gallery-assets:v1';
    const MIXINS = [
