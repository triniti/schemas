...
final class LinkAssetsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'triniti:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'triniti:dam:command:link-assets:v1';
    const MIXINS = [
