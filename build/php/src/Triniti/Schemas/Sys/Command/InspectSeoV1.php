...
final class InspectSeoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:sys:command:inspect-seo:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:command:inspect-seo';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:command:inspect-seo:v1';
    const MIXINS = [
