...
{
    const SCHEMA_ID = 'pbj:triniti:sys:command:purge-cache:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:command:purge-cache';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:command:purge-cache:v1';
    const MIXINS = [
