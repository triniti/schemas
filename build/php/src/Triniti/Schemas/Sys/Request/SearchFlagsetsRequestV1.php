...
final class SearchFlagsetsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:sys:request:search-flagsets-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:request:search-flagsets-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-flagsets-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchFlagsetsSort::class)
                    ->build(),
            ],
            self::MIXINS
        );
