...
final class ListAllFlagsetsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:sys:request:list-all-flagsets-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:request:list-all-flagsets-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:request:list-all-flagsets-response:v1';
    const MIXINS = [
