...
final class SearchRedirectsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-redirects-request:v1';
    const MIXINS = [
