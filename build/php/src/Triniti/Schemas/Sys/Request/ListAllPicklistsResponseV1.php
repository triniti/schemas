...
final class ListAllPicklistsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:sys:request:list-all-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:request:list-all-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:request:list-all-picklists-response:v1';
    const MIXINS = [
