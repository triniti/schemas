...
final class SearchPicklistsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:sys:request:search-picklists-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:request:search-picklists-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-picklists-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchPicklistsSort::class)
                    ->build(),
            ],
            self::MIXINS
        );
