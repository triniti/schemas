...
{
    const SCHEMA_ID = 'pbj:triniti:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-redirects-response:v1';
    const MIXINS = [
