...
final class SyncCfNodesV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:migrator:command:sync-cf-nodes:1-0-0';
    const SCHEMA_CURIE = 'triniti:migrator:command:sync-cf-nodes';
    const SCHEMA_CURIE_MAJOR = 'triniti:migrator:command:sync-cf-nodes:v1';
    const MIXINS = [
