...
final class SearchPromotionsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-promotions-request:v1';
    const MIXINS = [
