...
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:render-promotion-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:render-promotion-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:render-promotion-response:v1';
    const MIXINS = [
