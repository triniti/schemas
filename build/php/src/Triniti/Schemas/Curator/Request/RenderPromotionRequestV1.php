...
final class RenderPromotionRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:render-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:render-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:render-promotion-request:v1';
    const MIXINS = [
