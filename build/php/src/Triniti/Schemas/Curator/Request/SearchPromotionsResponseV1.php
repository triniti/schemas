...
final class SearchPromotionsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-promotions-response:v1';
    const MIXINS = [
