...
final class SearchTeasersResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-teasers-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-teasers-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-teasers-response:v1';
    const MIXINS = [
