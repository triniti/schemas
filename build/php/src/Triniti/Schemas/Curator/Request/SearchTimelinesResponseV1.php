...
final class SearchTimelinesResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-timelines-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-timelines-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-timelines-response:v1';
    const MIXINS = [
