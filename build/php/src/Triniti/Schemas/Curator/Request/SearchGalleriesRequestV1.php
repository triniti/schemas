...
final class SearchGalleriesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-galleries-request:v1';
    const MIXINS = [
