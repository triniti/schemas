...
final class SearchWidgetsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-widgets-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-widgets-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-widgets-request:v1';
    const MIXINS = [
