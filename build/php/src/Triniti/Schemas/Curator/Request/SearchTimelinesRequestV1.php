...
final class SearchTimelinesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-timelines-request:v1';
    const MIXINS = [
