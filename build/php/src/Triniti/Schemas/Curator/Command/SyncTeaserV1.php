...
final class SyncTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:command:sync-teaser:v1';
    const MIXINS = [
