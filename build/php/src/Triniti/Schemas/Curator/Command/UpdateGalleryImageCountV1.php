...
final class UpdateGalleryImageCountV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:curator:command:update-gallery-image-count:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:command:update-gallery-image-count';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:command:update-gallery-image-count:v1';
    const MIXINS = [
