...
{
    const SCHEMA_ID = 'pbj:triniti:curator:event:teaser-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'triniti:curator:event:teaser-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'triniti:curator:event:teaser-slotting-removed:v1';
    const MIXINS = [
