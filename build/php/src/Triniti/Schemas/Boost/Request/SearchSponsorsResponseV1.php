...
// @link http://schemas.triniti.io/json-schema/triniti/boost/request/search-sponsors-response/1-0-0.json#
namespace Triniti\Schemas\Boost\Request;
...
final class SearchSponsorsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:boost:request:search-sponsors-response:v1';
    const MIXINS = [
