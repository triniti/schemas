...
// @link http://schemas.triniti.io/json-schema/triniti/boost/request/search-sponsors-request/1-0-0.json#
...
final class SearchSponsorsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:boost:request:search-sponsors-request:v1';
    const MIXINS = [
