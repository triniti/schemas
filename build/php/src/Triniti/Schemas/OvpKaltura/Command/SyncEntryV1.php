...
final class SyncEntryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp.kaltura:command:sync-entry:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp.kaltura:command:sync-entry';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp.kaltura:command:sync-entry:v1';
    const MIXINS = [
