...
// @link http://schemas.triniti.io/json-schema/triniti/notify/request/search-notifications-response/1-0-0.json#
namespace Triniti\Schemas\Notify\Request;
...
final class SearchNotificationsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:notify:request:search-notifications-response:v1';
    const MIXINS = [
