...
final class SearchNotificationsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:notify:request:search-notifications-request:v1';
    const MIXINS = [
