...
final class NotificationFailedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'triniti:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'triniti:notify:event:notification-failed:v1';
    const MIXINS = [
