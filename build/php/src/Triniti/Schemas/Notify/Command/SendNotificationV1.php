...
// @link http://schemas.triniti.io/json-schema/triniti/notify/command/send-notification/1-0-0.json#
namespace Triniti\Schemas\Notify\Command;
...
final class SendNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'triniti:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'triniti:notify:command:send-notification:v1';
    const MIXINS = [
