...
final class SearchChannelsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:search-channels-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:search-channels-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:search-channels-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchChannelsSort::class)
                    ->build(),
            ],
            self::MIXINS
        );
