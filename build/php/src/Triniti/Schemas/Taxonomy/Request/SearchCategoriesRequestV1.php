...
// @link http://schemas.triniti.io/json-schema/triniti/taxonomy/request/search-categories-request/1-0-0.json#
...
final class SearchCategoriesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:search-categories-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:search-categories-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:search-categories-request:v1';
    const MIXINS = [
