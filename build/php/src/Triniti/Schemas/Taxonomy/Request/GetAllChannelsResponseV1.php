...
// @link http://schemas.triniti.io/json-schema/triniti/taxonomy/request/get-all-channels-response/1-0-0.json#
...
final class GetAllChannelsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:get-all-channels-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:get-all-channels-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:get-all-channels-response:v1';
    const MIXINS = [
