...
final class SearchChannelsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:search-channels-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:search-channels-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:search-channels-response:v1';
    const MIXINS = [
