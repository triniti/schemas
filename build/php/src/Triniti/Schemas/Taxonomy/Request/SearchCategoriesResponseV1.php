...
// @link http://schemas.triniti.io/json-schema/triniti/taxonomy/request/search-categories-response/1-0-0.json#
namespace Triniti\Schemas\Taxonomy\Request;
...
final class SearchCategoriesResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:search-categories-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:search-categories-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:search-categories-response:v1';
    const MIXINS = [
