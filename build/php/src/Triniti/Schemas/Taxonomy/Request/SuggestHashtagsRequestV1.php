...
// @link http://schemas.triniti.io/json-schema/triniti/taxonomy/request/suggest-hashtags-request/1-0-0.json#
...
final class SuggestHashtagsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:suggest-hashtags-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:suggest-hashtags-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:suggest-hashtags-request:v1';
    const MIXINS = [
