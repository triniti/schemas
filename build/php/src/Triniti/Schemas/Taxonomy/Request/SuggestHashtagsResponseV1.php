...
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:suggest-hashtags-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:suggest-hashtags-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:suggest-hashtags-response:v1';
    const MIXINS = [
