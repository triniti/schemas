...
// @link http://schemas.triniti.io/json-schema/triniti/taxonomy/request/get-all-channels-request/1-0-0.json#
...
final class GetAllChannelsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:taxonomy:request:get-all-channels-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:taxonomy:request:get-all-channels-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:get-all-channels-request:v1';
    const MIXINS = [
