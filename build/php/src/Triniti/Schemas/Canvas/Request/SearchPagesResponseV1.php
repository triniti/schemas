...
// @link http://schemas.triniti.io/json-schema/triniti/canvas/request/search-pages-response/1-0-0.json#
namespace Triniti\Schemas\Canvas\Request;
...
final class SearchPagesResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:canvas:request:search-pages-response:v1';
    const MIXINS = [
