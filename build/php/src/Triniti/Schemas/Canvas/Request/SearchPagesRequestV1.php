...
// @link http://schemas.triniti.io/json-schema/triniti/canvas/request/search-pages-request/1-0-0.json#
...
final class SearchPagesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:canvas:request:search-pages-request:v1';
    const MIXINS = [
