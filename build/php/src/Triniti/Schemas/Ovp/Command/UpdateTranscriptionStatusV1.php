...
final class UpdateTranscriptionStatusV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:command:update-transcription-status:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:command:update-transcription-status';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:command:update-transcription-status:v1';
    const MIXINS = [
