...
final class UpdateTranscodingStatusV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:command:update-transcoding-status:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:command:update-transcoding-status';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:command:update-transcoding-status:v1';
    const MIXINS = [
