...
final class TranscodingFailedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:event:transcoding-failed:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:event:transcoding-failed';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:event:transcoding-failed:v1';
    const MIXINS = [
