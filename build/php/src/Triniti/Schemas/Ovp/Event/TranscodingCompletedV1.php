...
final class TranscodingCompletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:event:transcoding-completed:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:event:transcoding-completed';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:event:transcoding-completed:v1';
    const MIXINS = [
