...
final class TranscriptionStartedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:event:transcription-started:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:event:transcription-started';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:event:transcription-started:v1';
    const MIXINS = [
