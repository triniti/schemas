...
final class TranscriptionCompletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:event:transcription-completed:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:event:transcription-completed';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:event:transcription-completed:v1';
    const MIXINS = [
