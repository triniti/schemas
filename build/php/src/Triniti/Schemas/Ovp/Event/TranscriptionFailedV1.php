...
final class TranscriptionFailedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:event:transcription-failed:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:event:transcription-failed';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:event:transcription-failed:v1';
    const MIXINS = [
