...
final class TranscodingStartedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:event:transcoding-started:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:event:transcoding-started';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:event:transcoding-started:v1';
    const MIXINS = [
