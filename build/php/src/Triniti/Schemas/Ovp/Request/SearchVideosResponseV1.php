...
namespace Triniti\Schemas\Ovp\Request;
...
final class SearchVideosResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:request:search-videos-response:v1';
    const MIXINS = [
