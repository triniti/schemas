...
final class SearchVideosRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp:request:search-videos-request:v1';
    const MIXINS = [
