...
final class StopChannelV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:triniti:ovp.medialive:command:stop-channel:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp.medialive:command:stop-channel';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp.medialive:command:stop-channel:v1';
    const MIXINS = [
