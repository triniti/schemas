...
{
    const SCHEMA_ID = 'pbj:triniti:ovp.medialive:event:channel-stopped:1-0-0';
    const SCHEMA_CURIE = 'triniti:ovp.medialive:event:channel-stopped';
    const SCHEMA_CURIE_MAJOR = 'triniti:ovp.medialive:event:channel-stopped:v1';
    const MIXINS = [
