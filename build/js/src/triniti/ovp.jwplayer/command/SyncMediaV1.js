...
export default class SyncMediaV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SyncMediaV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:ovp.jwplayer:command:sync-media:1-0-1';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:ovp.jwplayer:command:sync-media';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:ovp.jwplayer:command:sync-media:v1';
