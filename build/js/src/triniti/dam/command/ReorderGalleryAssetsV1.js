// @link http://schemas.triniti.io/json-schema/triniti/dam/command/reorder-gallery-assets/1-0-0.json#
  ...
  static defineSchema() {
    return new Schema(this.SCHEMA_ID, this,
      [
         ...
         */
        Fb.create('old_gallery_refs', T.NodeRefType.create())
          .asAMap()
          .build(),
      ],
      this.MIXINS,
...
const M = ReorderGalleryAssetsV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:dam:command:reorder-gallery-assets:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:dam:command:reorder-gallery-assets';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:dam:command:reorder-gallery-assets:v1';
