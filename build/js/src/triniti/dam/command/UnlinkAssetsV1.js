// @link http://schemas.triniti.io/json-schema/triniti/dam/command/unlink-assets/1-0-0.json#
  ...
  static defineSchema() {
    return new Schema(this.SCHEMA_ID, this,
      [
         ...
         */
        Fb.create('asset_refs', T.NodeRefType.create())
          .asASet()
          .build(),
      ],
      this.MIXINS,
...
const M = UnlinkAssetsV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:dam:command:unlink-assets:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:dam:command:unlink-assets';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:dam:command:unlink-assets:v1';
