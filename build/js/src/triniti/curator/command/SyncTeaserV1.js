// @link http://schemas.triniti.io/json-schema/triniti/curator/command/sync-teaser/1-0-0.json#
  ...
  static defineSchema() {
    return new Schema(this.SCHEMA_ID, this,
      [
         ...
         */
        Fb.create('teaser_ref', T.NodeRefType.create())
          .build(),
      ],
      this.MIXINS,
    );
...
const M = SyncTeaserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:curator:command:sync-teaser:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:curator:command:sync-teaser';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:curator:command:sync-teaser:v1';
