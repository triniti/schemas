// @link http://schemas.triniti.io/json-schema/triniti/curator/request/search-timelines-response/1-0-0.json#
...
const M = SearchTimelinesResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:curator:request:search-timelines-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:curator:request:search-timelines-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:curator:request:search-timelines-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  ...
  'triniti:curator:mixin:search-timelines-response:v1',
