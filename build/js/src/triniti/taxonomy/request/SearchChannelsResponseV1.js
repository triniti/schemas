// @link http://schemas.triniti.io/json-schema/triniti/taxonomy/request/search-channels-response/1-0-0.json#
...
export default class SearchChannelsResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SearchChannelsResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:taxonomy:request:search-channels-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:taxonomy:request:search-channels-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:search-channels-response:v1';
