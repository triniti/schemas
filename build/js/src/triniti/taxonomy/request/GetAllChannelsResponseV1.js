...
const M = GetAllChannelsResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:taxonomy:request:get-all-channels-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:taxonomy:request:get-all-channels-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:taxonomy:request:get-all-channels-response:v1';
