// @link http://schemas.triniti.io/json-schema/triniti/apollo/event/reactions-added/1-0-0.json#
...
export default class ReactionsAddedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ReactionsAddedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:apollo:event:reactions-added:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:apollo:event:reactions-added';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:apollo:event:reactions-added:v1';
