...
export default class SeoInspectedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SeoInspectedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:sys:event:seo-inspected:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:sys:event:seo-inspected';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:sys:event:seo-inspected:v1';
