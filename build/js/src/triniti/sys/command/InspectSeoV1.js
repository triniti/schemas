// @link http://schemas.triniti.io/json-schema/triniti/sys/command/inspect-seo/1-0-0.json#
...
export default class InspectSeoV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = InspectSeoV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:sys:command:inspect-seo:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:sys:command:inspect-seo';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:sys:command:inspect-seo:v1';
