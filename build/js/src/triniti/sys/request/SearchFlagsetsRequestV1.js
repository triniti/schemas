// @link http://schemas.triniti.io/json-schema/triniti/sys/request/search-flagsets-request/1-0-0.json#
...
export default class SearchFlagsetsRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create('sort', T.StringEnumType.create())
          .withDefault(SearchFlagsetsSort.TITLE_ASC)
          .classProto(SearchFlagsetsSort)
          .build(),
      ],
      this.MIXINS,
    );
...
const M = SearchFlagsetsRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:sys:request:search-flagsets-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:sys:request:search-flagsets-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-flagsets-request:v1';
