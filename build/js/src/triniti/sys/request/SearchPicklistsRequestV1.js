// @link http://schemas.triniti.io/json-schema/triniti/sys/request/search-picklists-request/1-0-0.json#
...
export default class SearchPicklistsRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create('sort', T.StringEnumType.create())
          .withDefault(SearchPicklistsSort.TITLE_ASC)
          .classProto(SearchPicklistsSort)
          .build(),
      ],
      this.MIXINS,
    );
...
const M = SearchPicklistsRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:sys:request:search-picklists-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:sys:request:search-picklists-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-picklists-request:v1';
