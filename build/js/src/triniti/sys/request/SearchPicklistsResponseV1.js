// @link http://schemas.triniti.io/json-schema/triniti/sys/request/search-picklists-response/1-0-0.json#
...
export default class SearchPicklistsResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SearchPicklistsResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:sys:request:search-picklists-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:sys:request:search-picklists-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:sys:request:search-picklists-response:v1';
