// @link http://schemas.triniti.io/json-schema/triniti/sys/request/list-all-flagsets-response/1-0-0.json#
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create('metas', T.TextType.create())
          .asAMap()
          .build(),
        Fb.create('flagsets', T.NodeRefType.create())
          .asASet()
          .build(),
      ],
      this.MIXINS,
...
const M = ListAllFlagsetsResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:sys:request:list-all-flagsets-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:sys:request:list-all-flagsets-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:sys:request:list-all-flagsets-response:v1';
