// @link http://schemas.triniti.io/json-schema/triniti/ovp.medialive/event/channel-stopped/1-0-0.json#
...
export default class ChannelStoppedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ChannelStoppedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:triniti:ovp.medialive:event:channel-stopped:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'triniti:ovp.medialive:event:channel-stopped';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'triniti:ovp.medialive:event:channel-stopped:v1';
